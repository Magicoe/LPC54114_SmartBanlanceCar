...
void tb6612_func_init(void)
{
    ...
    CTIMER_SetupPwm(CTIMER0, kCTIMER_Match_0, 0, 20000, TB6612PWMASrcClkHz, false);
    ...
    CTIMER_SetupPwm(CTIMER1, kCTIMER_Match_1, 0, 20000, TB6612PWMBSrcClkHz, false);
...
{
    CTIMER_SetupPwm(CTIMER0, kCTIMER_Match_0, duty, 20000, TB6612PWMASrcClkHz, false);
...
{
    CTIMER_SetupPwm(CTIMER1, kCTIMER_Match_1, duty, 20000, TB6612PWMBSrcClkHz, false);
    if(direction == 0)
    {
        TB6612_BIN1_SET();
        TB6612_BIN2_SET();
