...
#define MPU9250_SPI_WRITE_REG_CMD(x)  (x)         /* ????0??? */
#define MPU9250_SPI_READ_REG_CMD(x)   ((x) | 0x80) /* ????1??? */
...
#define MPU9250_SMPLRT_DIV              0x19 //??????,???:0x07(125Hz)
#define MPU9250_CONFIG                  0x1A //??????,???:0x06(5Hz)
#define MPU9250_GYRO_CONFIG             0x1B //??????????,???:0x18(???,2000deg/s)
#define MPU9250_GYRO_CONFIG_GYRO_FS_SEL(x) ((((uint8_t)(x)) & 0x3)<<3)

#define MPU9250_ACCEL_CONFIG            0x1C //?????????????????,???:0x01(???,2G,5Hz)
#define MPU9250_ACCEL_CONFIG_ACCEL_FS_SEL(x) ((((uint8_t)(x)) & 0x3)<<3)
...
#define MPU9250_PWR_MGMT_1              0x6B //????,???:0x00(????)
#define MPU9250_PWR_MGMT_1_H_RESET_MASK (1U << 7)
#define MPU9250_PWR_MGMT_1_CLKSEL(x)    ((x) & 0x7U)

#define MPU9250_PWR_MGMT_2              0x6C
#define MPU9250_FIFO_COUNTH             0x72
#define MPU9250_FIFO_COUNTL             0x73
#define MPU9250_FIFO_R_W                0x74
#define MPU9250_WHO_AM_I                0x75 //ID???(????0x71,??)
...
#define MPU9250_AK8963_CONTINUOUS_MEASUREMENT 0x16 //MODE2????100Hz
...
#define MPU9250_WHOAMI        0x75  /* ????0x71 */
