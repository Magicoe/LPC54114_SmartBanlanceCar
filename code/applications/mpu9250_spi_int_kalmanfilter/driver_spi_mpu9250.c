...
volatile MPU9250_SensorInfo_T   g_MPU9250Values = {0, 0, 0};
...
void mpu8250_value_read(MPU9250_SensorInfo_T *sensorDat)
{
	...
	sensorDat->AccX  = ((int16_t)g_MPU9250RxBuf[ 1]<<8) | g_MPU9250RxBuf[ 2];
	sensorDat->AccY  = ((int16_t)g_MPU9250RxBuf[ 3]<<8) | g_MPU9250RxBuf[ 4];
	sensorDat->AccZ  = ((int16_t)g_MPU9250RxBuf[ 5]<<8) | g_MPU9250RxBuf[ 6];
    
    sensorDat->Temperature = ((int16_t)g_MPU9250RxBuf[ 7]<<8) | g_MPU9250RxBuf[ 8]; 
    
	sensorDat->GyrX = ((int16_t)g_MPU9250RxBuf[ 9]<<8) | g_MPU9250RxBuf[10];
	sensorDat->GyrY = ((int16_t)g_MPU9250RxBuf[11]<<8) | g_MPU9250RxBuf[12];
	sensorDat->GyrZ = ((int16_t)g_MPU9250RxBuf[13]<<8) | g_MPU9250RxBuf[14];
	
    sensorDat->MagX  = ((int16_t)g_MPU9250RxBuf[17]<<8) | g_MPU9250RxBuf[16];
	sensorDat->MagY  = ((int16_t)g_MPU9250RxBuf[19]<<8) | g_MPU9250RxBuf[18];
	sensorDat->MayZ  = ((int16_t)g_MPU9250RxBuf[21]<<8) | g_MPU9250RxBuf[20];
