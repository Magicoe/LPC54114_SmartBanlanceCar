...
void mpu9250_dmaRead_init(void)
{
    uint8_t i;
...
volatile uint32_t gMPU9250Status = 0;
volatile MPU9250_SensorInfo_T gMPU9250Data;

void mpu9250_read_task(void)
{
    if(gMPU9250Status == 0)
    {
        MPU9250_CS_CLR();
    ...
    if(gMPU9250Status == 1)
    {
        if (g_MPU9250SpiDMAFinished == true)
        {
            gMPU9250Status = 2;
            return;
        }
    ...
    if(gMPU9250Status == 2)
    {
        gMPU9250Data.AccX        = (int16_t)(g_MPU9250RxDwBuf[ 1]<<8) | (g_MPU9250RxDwBuf[ 2]&0x000000FF);
        gMPU9250Data.AccY        = (int16_t)(g_MPU9250RxDwBuf[ 3]<<8) | (g_MPU9250RxDwBuf[ 4]&0x000000FF);
        gMPU9250Data.AccZ        = (int16_t)(g_MPU9250RxDwBuf[ 5]<<8) | (g_MPU9250RxDwBuf[ 6]&0x000000FF);
        
        gMPU9250Data.Temperature = (int16_t)(g_MPU9250RxDwBuf[ 7]<<8) | (g_MPU9250RxDwBuf[ 8]&0x000000FF); 
        
        gMPU9250Data.GyrX        = (int16_t)(g_MPU9250RxDwBuf[ 9]<<8) | (g_MPU9250RxDwBuf[10]&0x000000FF);
        gMPU9250Data.GyrY        = (int16_t)(g_MPU9250RxDwBuf[11]<<8) | (g_MPU9250RxDwBuf[12]&0x000000FF);
        gMPU9250Data.GyrZ        = (int16_t)(g_MPU9250RxDwBuf[13]<<8) | (g_MPU9250RxDwBuf[14]&0x000000FF);
        
        gMPU9250Data.MagX        = (int16_t)(g_MPU9250RxDwBuf[17]<<8) | (g_MPU9250RxDwBuf[16]&0x000000FF);
        gMPU9250Data.MagY        = (int16_t)(g_MPU9250RxDwBuf[19]<<8) | (g_MPU9250RxDwBuf[18]&0x000000FF);
        gMPU9250Data.MagZ        = (int16_t)(g_MPU9250RxDwBuf[21]<<8) | (g_MPU9250RxDwBuf[20]&0x000000FF);
        MPU9250_CS_SET();
        gMPU9250Status = 0;
	}
}
void mpu9250_value_read(MPU9250_SensorInfo_T *sensorDat)
{
#if 0
    ...
    sensorDat->AccX = gMPU9250Data.AccX;
    sensorDat->AccY = gMPU9250Data.AccY;
    sensorDat->AccZ = gMPU9250Data.AccZ;
    
    sensorDat->Temperature = gMPU9250Data.Temperature; 
    
    sensorDat->GyrX = gMPU9250Data.GyrX;
    sensorDat->GyrY = gMPU9250Data.GyrY;
    sensorDat->GyrZ = gMPU9250Data.GyrZ;
    
    sensorDat->MagX = gMPU9250Data.MagX;
    sensorDat->MagY = gMPU9250Data.MagY;
    sensorDat->MagZ = gMPU9250Data.MagZ;
#endif
//    sensorDat = gMPU9250Data;
}
